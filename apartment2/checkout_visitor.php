        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">รายชื่อของผู้เช่า</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                <tr>
                  ...
                  <td><a href="action-visitor.php?editid=<?php echo $row['ID'];?>" title="ลบ" class='btn btn-danger btn-xs'>ย้ายออก</a></td>

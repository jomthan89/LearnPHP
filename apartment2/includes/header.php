            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-left">
                  ...
                  <a href="change-password.php" class="btn btn-default btn-flat">เปลี่ยนรหัสผ่าน</a>   
                </div>


                <div class="pull-right">
                  <a href="logout.php" class="btn btn-default btn-flat" onclick="return confirm('ต้องการออกจากระบบหรือไม่')"><i class="fa fa-power-off" style="color:red;"></i></a>
                </div>

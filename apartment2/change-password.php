  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">หน้าเปลี่ยนรหัสผ่าน</li>
      </ol>
    </section>
      ...
      <?php if($msg){ echo "<div class='alert alert-success alert-dismissible'>
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">กรุณากรอกรายละเอียดด้านล่างนี้</h3>
          ...
          <!-- /.box-header -->
            ...
            <button type="submit" class="btn btn-block btn-success btn-lg" name="update">ยืนยัน</button>
            </div>
          </div>
          </form>

...
<div class="wrapper">
    ...
    <?php $page='apartment4'; include 'includes/sidebar.php'?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">ห้องพักว่าง</li>
      </ol>
    </section>
    ...
    <div class="row">
        <div class="col-xs-10">
          ...
          <div class="box">
            ...
            <div class="box-header">
                <h5 class="box-title">จำนวนห้องว่าง</button></a></h5>
            </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover table-striped">
                ...
                <?php
                $ret=mysqli_query($con,"SELECT * from apartment WHERE apartment_status = 'ว่างอยู่'");
                $cnt=1;
